...
if __name__ == "__main__":
  ...
  for i, sample in enumerate(test):
    toks, _, inds = sample
    for tok, ind in zip(toks.split(), inds.split()):
      ind = int(ind)
      result[ind] = baseline.predict(tok)

  import gen_kaggle_result

  gen_kaggle_result.gen_kaggle_result(result, "baseline_kaggle.txt")